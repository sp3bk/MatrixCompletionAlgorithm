...
data.raw2 <- readRDS("compiled121.Rda")
...
saveRDS(data.raw,file="compiled121.Rda")

gx2 <- readRDS("compiledx121.Rda")
gy2 <- readRDS("compiledy121.Rda")
...
saveRDS(gx, file="compiledx121.Rda")
saveRDS(gy, file="compiledy121.Rda")
