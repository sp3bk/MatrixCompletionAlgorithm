...
dendrites <- t(as.matrix(read.csv("Dendrites.csv", sep=","))) #tranpose to change row and col; dendrites always +
...
#x <- graphx(xrandom, x2,y2,xbar1, xbar2, ybar1, ybar1p, MaxNumColors,warmcolor, coldcolor, 0.5) #
...
#gx2 <- c()
#gy2 <- c()
#foo = seq(1, 100, by=4.75)
for (i in 1:30){
  x <- graphx(x.ad, x2,y2,xbar1, xbar2, ybar1,ybar1p, MaxNumColors,warmcolor, coldcolor, i/30.0)
  softimpute(seednumber)
  b=graph(x.ad, "x2.csv", x2, y2,xbar1,xbar2,ybar1, ybar1p,MaxNumColors,warmcolor, coldcolor)
  #gx2 <- c(gx2, 100.0-(i*10.0))
...
#c=graph(x.ad, "x3.csv", x2, y2,xbar1,xbar2,ybar1,ybar1p,MaxNumColors,warmcolor, coldcolor)

####################PYTHON using numpy and pandas: MEAN
#python.load("Numpy.py")
#d=graph(x.ad, "x4.csv", x2, y2,xbar1,xbar2,ybar1,ybar1p,MaxNumColors,warmcolor, coldcolor)

####################PYTHON using numpy and pandas: MEDIAN
#python.load("Numpy2.py")
#e=graph(x.ad, "x5.csv", x2, y2,xbar1,xbar2,ybar1,ybar1p,MaxNumColors,warmcolor, coldcolor)

############
########PYTHON using numpy and pandas: MOST FREQUENT
#python.load("Numpy3.py")
#f=graph(x.ad, "x6.csv", x2, y2,xbar1,xbar2,ybar1,ybar1p,MaxNumColors,warmcolor, coldcolor)
